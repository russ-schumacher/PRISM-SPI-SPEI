...
path_to_files = "/data/rschumac/prism/monthly/PRISM_tmin_*_bil.nc"
...
data_sub = data_sub.rename({'Band1':'tmin'})
data_sub.tmin.attrs['units'] = "degree_Celsius"
## sort by time because they might get out of order
data_sub = data_sub.sortby('time')
### reorder dimensions
data_sub['tmin'] = data_sub['tmin'].transpose("lat","lon","time")

# In[40]:

print("writing file")
data_sub.to_netcdf("PRISM_tmin_monthly_CO_all.nc")

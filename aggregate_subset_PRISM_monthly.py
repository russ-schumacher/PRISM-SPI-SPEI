...
path_to_files = "/data/rschumac/prism/monthly/PRISM_ppt_*_bil.nc"
...
data_sub = data_sub.rename({'Band1':'prcp'})
data_sub.prcp.attrs['units'] = "millimeter"
## sort by time because they might get out of order
data_sub = data_sub.sortby('time')
### reorder dimensions
#data_sub['prcp'] = data_sub['prcp'].transpose("lat","lon","time")

# In[40]:

print("writing file")
data_sub.to_netcdf("PRISM_prcp_monthly_CO_all.nc")
